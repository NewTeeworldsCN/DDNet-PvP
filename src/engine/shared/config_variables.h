...
MACRO_CONFIG_STR(SvAxiomBaseUrl, sv_axiom_base_url, 256, "", CFGFLAG_SERVER, "Url for axiom")
MACRO_CONFIG_STR(SvAxiomToken, sv_axiom_token, 256, "", CFGFLAG_SERVER, "Token for axiom")
MACRO_CONFIG_STR(SvAxiomSecret1, sv_axiom_secret1, 64, "", CFGFLAG_SERVER, "Super secret")
MACRO_CONFIG_STR(SvAxiomSecret2, sv_axiom_secret2, 64, "", CFGFLAG_SERVER, "Super secret")
MACRO_CONFIG_STR(SvAxiomSecret3, sv_axiom_secret3, 64, "", CFGFLAG_SERVER, "Super secret")
MACRO_CONFIG_STR(SvAxiomSecret4, sv_axiom_secret4, 64, "", CFGFLAG_SERVER, "Super secret")
MACRO_CONFIG_STR(SvAxiomSecret5, sv_axiom_secret5, 64, "", CFGFLAG_SERVER, "Super secret")
MACRO_CONFIG_STR(SvAxiomSecret6, sv_axiom_secret6, 64, "", CFGFLAG_SERVER, "Super secret")
MACRO_CONFIG_STR(SvAxiomSecret7, sv_axiom_secret7, 64, "", CFGFLAG_SERVER, "Super secret")
MACRO_CONFIG_STR(SvAxiomSecret8, sv_axiom_secret8, 64, "", CFGFLAG_SERVER, "Super secret")
MACRO_CONFIG_STR(SvAxiomSecret9, sv_axiom_secret9, 64, "", CFGFLAG_SERVER, "Super secret")
MACRO_CONFIG_STR(SvAxiomSecret10, sv_axiom_secret10, 64, "", CFGFLAG_SERVER, "Super secret")
MACRO_CONFIG_STR(SvAxiomSecret11, sv_axiom_secret11, 64, "", CFGFLAG_SERVER, "Super secret")
MACRO_CONFIG_STR(SvAxiomSecret12, sv_axiom_secret12, 64, "", CFGFLAG_SERVER, "Super secret")
MACRO_CONFIG_STR(SvAxiomSecret13, sv_axiom_secret13, 64, "", CFGFLAG_SERVER, "Super secret")
MACRO_CONFIG_STR(SvAxiomSecret14, sv_axiom_secret14, 64, "", CFGFLAG_SERVER, "Super secret")
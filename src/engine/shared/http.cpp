...
void CHttpRequest::WriteToFile(class IStorage *pStorage, const char *pDest, int StorageType)
{
...
void CHttpRequest::WriteToFileAndMemory(class IStorage *pStorage, const char *pDest, int StorageType)
{
